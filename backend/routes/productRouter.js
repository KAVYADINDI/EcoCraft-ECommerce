...
router.post('/', upload.array('images', 5), async (req, res) => {
  try {
    ...
    const commissionRate = artist.commissionRate;
    console.log('Commission rate for artistID', req.body.artistID, ':', commissionRate);
    const listingPrice = req.body.price / (1 - commissionRate / 100);
    console.log('Calculated listing price:', listingPrice);
